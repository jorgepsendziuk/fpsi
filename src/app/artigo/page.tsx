      ...
      <Container maxWidth="md" sx={{ py: 5, pb: 8, "& .MuiTypography-body1": { textAlign: "justify" }, "& .MuiTypography-body2": { textAlign: "justify" } }}>
        ...
        <Paper variant="outlined" sx={{ p: 4, mb: 4 }}>
          <Typography variant="h5" component="h1" sx={{ fontWeight: "bold", textAlign: "center", textTransform: "uppercase", mb: 1 }}>
            Implementação open source do Framework de Privacidade e Segurança da Informação no Programa PPSI 2.0 com apoio assistido por IA em mapeamentos
          </Typography>
          <Typography variant="h6" sx={{ textAlign: "center", fontStyle: "italic", textTransform: "uppercase", mb: 3 }}>
            OPEN-SOURCE IMPLEMENTATION OF THE PRIVACY AND INFORMATION SECURITY FRAMEWORK UNDER BRAZIL&apos;S PPSI 2.0 PROGRAM WITH AI-ASSISTED MAPPING SUPPORT
          </Typography>
        ...
        <Paper id="introducao" variant="outlined" sx={{ p: 3, mb: 3, scrollMarginTop: 80 }}>
          ...
          <Typography variant="body1" paragraph>
            Este artigo apresenta uma implementação open source do Framework FPSI, desenvolvida com tecnologias web, que aborda as limitações identificadas e permite implantação sem custo de licença e adaptação para órgãos públicos, empresas e consultores. O <strong>Framework de Privacidade e Segurança da Informação</strong> integra o <strong>Programa de Privacidade e Segurança da Informação (PPSI 2.0)</strong>; a solução acompanha a <strong>ferramenta oficial vigente</strong> e o respectivo catálogo de controles e medidas, além de instrumentos do programa (mapeamento, ROPA, normas de referência, governança) e de uma <strong>trajetória de assistência por inteligência artificial</strong> para acelerar levantamentos, sempre sujeita a validação técnica e revisão humana. O trabalho está alinhado ao eixo temático de Privacidade e Proteção de Dados, abordando o impacto das legislações de proteção de dados (LGPD e correlatas), medidas de compliance digital e cultura organizacional voltada à privacidade.
          </Typography>
          <Typography variant="body1" paragraph>
        ...
        <Paper id="marco" variant="outlined" sx={{ p: 3, mb: 3, scrollMarginTop: 80 }}>
          ...
          <Typography variant="body1" paragraph>
            O conjunto de <strong>medidas de implementação</strong> associadas aos 31 controles acompanha as atualizações divulgadas na <strong>Ferramenta oficial</strong> do Framework; alterações na <strong>quantidade</strong> de itens ou na <strong>qualidade</strong> das formulações (redação, recortes temáticos ou critérios) refletem revisões periódicas do órgão gestor. Implementações digitais devem manter <strong>paridade</strong> com a planilha e o manual <strong>em vigor</strong> para que níveis de maturidade e plano de trabalho permaneçam comparáveis ao referencial publicado.
          </Typography>
          <Typography variant="body1" paragraph>
        ...
        <Paper id="funcionalidades" variant="outlined" sx={{ p: 3, mb: 3, scrollMarginTop: 80 }}>
          ...
          <Typography variant="body1" paragraph>
            A implementação cobre os seguintes módulos, alinhados ao Framework oficial e ao <strong>Programa PPSI 2.0</strong>: Diagnóstico de maturidade, plano de trabalho, políticas, ROPA, portal de privacidade, pedidos dos titulares, <strong>conformidade LGPD</strong> (incluindo <strong>mapeamento de dados pessoais</strong> com listas de domínio compatíveis com o inventário, <strong>normas e documentos de referência</strong> por programa, vínculo entre levantamentos e operações de tratamento quando aplicável), responsáveis, governança de papéis e auditoria.
          </Typography>
          <Typography variant="body1" paragraph>
          ...
          <Typography variant="body1" paragraph>
            <strong>Diagnóstico de maturidade:</strong> estrutura em árvore (diagnóstico → controle → medida); respostas e justificativas por medida; níveis INCC de 0 a 5; dashboard de maturidade com indicadores visuais; 31 controles e respectivas medidas alinhados ao <strong>Framework</strong> no âmbito do <strong>PPSI 2.0</strong>. Onde o texto da medida remete à lei ou a boas práticas, a interface favorece a <strong>consulta contextual</strong> (por exemplo, trechos da LGPD ou menção a referenciais como CIS), reforçando o uso pedagógico do instrumento. O cálculo de maturidade implementa a fórmula oficial iMC = (∑PMC / (QMC - QMNAC)) / 2 × (1 + iNCC/100), com classificação em níveis Inicial, Básico, Intermediário, Em Aprimoramento e Aprimorado.
          </Typography>
          <Typography variant="body1" paragraph>
          ...
          <Typography variant="body1" paragraph>
            A implementação mantém <strong>coerência</strong> com a metodologia da Ferramenta oficial (controles, medidas, pesos e fórmulas de maturidade publicados pelo governo), acompanhando atualizações do catálogo quando divulgadas, de modo a preservar <strong>comparabilidade</strong> com o referencial de apoio ao programa.
          </Typography>
          <Typography variant="body1" paragraph>
            O diferencial educativo consiste em integrar o diagnóstico e a conformidade a uma <strong>trilha de referências</strong>: dispositivos da <strong>LGPD</strong>, fundamentos do próprio <strong>Framework</strong> e encadeamento com <strong>referenciais internacionais</strong> citados na base normativa do PPSI (como <strong>CIS</strong>, NIST e ISO/IEC), de modo que o usuário navegue da medida ou do levantamento ao texto normativo ou guia que a justifica — sem substituir parecer jurídico, mas reduzindo fricção na capacitação das equipes.
          </Typography>
          <Typography variant="body1" paragraph>
            No eixo de <strong>inteligência artificial</strong>, o projeto adota desenho <strong>centrado em privacidade e revisão humana</strong>: (1) <strong>catálogo curado</strong> de áreas e processos-tipo para apoiar o mapeamento inicial (sem dados pessoais, inspirado em materiais de boas práticas de inventário LGPD); (2) na interface de mapeamento, <strong>painel de processos de referência</strong> pesquisável e filtrável por setor, copiando campos seguros para o formulário; (3) <strong>API em servidor</strong> que solicita <strong>rascunhos estruturados</strong> a um modelo de linguagem usando apenas <strong>metadados institucionais</strong> do programa (evitando enviar dados de titulares ou conteúdo identificável desnecessário), com <strong>validação</strong> das respostas contra listas fechadas de domínio já previstas no sistema; (4) <strong>pré-visualização editável</strong> e gravação somente após aceitação explícita do analista ou DPO; (5) <strong>avisos</strong> de que o output é sugestão e não substitui análise do encarregado. A <strong>evolução em curso</strong> prevê assistência para gerar <strong>operações de ROPA</strong> a partir de mapeamentos validados — privilegiando regras determinísticas e texto legal sempre revisável —, além de limites de taxa e instrumentos de observabilidade no servidor. Esses itens traduzem, em linguagem de produto, o plano funcional de IA para mapeamento e ROPA em desenvolvimento no repositório aberto.
          </Typography>
        </Paper>
        ...
        <Paper id="referencias" variant="outlined" sx={{ p: 3, mb: 4, scrollMarginTop: 80 }}>
          ...
          <Typography variant="body2" component="div" sx={{ "& p": { mb: 1.5 }, textAlign: "left" }}>
            ...
            <p>GOVERNO FEDERAL. Ferramenta do Framework de Privacidade e Segurança da Informação. Planilha Excel. Disponível em: https://www.gov.br/mgi/pt-br/assuntos/seguranca-da-informacao/ferramenta-do-framework. Acesso em: 12 mar. 2026.</p>
