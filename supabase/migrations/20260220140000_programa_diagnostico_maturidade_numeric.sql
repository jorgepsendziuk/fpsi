-- Corrige score zerado: divisão numérica explícita e JOIN completo (incl. controle_numero).
-- Em alguns casos soma_pesos/total_medidas ou agregações podem vir como inteiro e zerar o score.
