-- JOIN entre controle_soma e medida_count só em (programa_id, controle_id, diagnostico_id).
-- Incluir controle_numero no JOIN pode falhar se houver diferença de tipo/null entre os CTEs.
