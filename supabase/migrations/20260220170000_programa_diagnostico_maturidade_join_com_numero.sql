-- JOIN entre controle_soma e medida_count inclui controle_numero.
-- Sem ele, as 8 linhas de cada CTE podem ser triplas (programa_id, controle_id, diagnostico_id)
-- diferentes e o JOIN em 3 colunas devolve 0. Usar IS NOT DISTINCT FROM para NULL-safe.
