-- Corrige o cálculo do score: incluir TODOS os controles com medidas no denominador,
-- mesmo os sem resposta (score 0), alinhando com useMaturityCache/getDiagnosticoMaturity.
-- Antes: score_controle usava INNER JOIN (controle_soma + medida_count), excluindo controles sem resposta.
-- Depois: medida_count LEFT JOIN controle_soma, incluindo controles com score 0.
...
-- Base em medida_count (todos os controles com medidas); LEFT JOIN controle_soma para incluir controles sem resposta
score_controle AS (
  SELECT
    mc.programa_id,
    mc.controle_id,
