-- Corrige score pela metade: a view produzia ~50% do valor esperado (ex: 0.43 vs 0.86 na página de diagnóstico).
-- A fórmula iMC usa (baseIndex/2)*incc_mult, mas a view estava aplicando efeito equivalente a /2 duas vezes.
-- Multiplicando o score final por 2 e limitando a 0-1 para alinhar com a página de diagnóstico.
...
SELECT
  b.programa_id,
  b.diagnostico_id,
  -- Corrige score pela metade: view produzia ~50% do valor da página de diagnóstico
