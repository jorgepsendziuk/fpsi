-- Ajuste: cast defensivo de resposta (text/numeric) e COALESCE(resposta, nova_resposta).
-- Garante que respostas gravadas em qualquer formato ou coluna entrem no cálculo.
